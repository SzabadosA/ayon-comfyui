...
class AyonPublisher:
    ...
    def _construct_publish_path(
        ...
        Returns the constructed path and the formatted template string.
        ...
        try:
            ...
            path_template = os.path.join(directory_template, file_template)
            ...
            return publish_path, path_template
        except Exception as e:
    ...
    def _create_representation(
        ...
        argument should be the formatted template string used to build the
        publish path.
        """
    ...
    def _publish_sequence(
        ...
        for file_path in files:
            ...
            publish_path, tmpl = self._construct_publish_path(
                file_path=file_path,
                project_name=project_name,
                folder_path=folder_path,
                task_name=task_name,
    ...
    def _publish_single_file(
        ...
        # Construct publish path
            publish_path, path_template = self._construct_publish_path(
                file_path=file_path,
                project_name=project_name,
                folder_path=folder_path,
                task_name=task_name,
